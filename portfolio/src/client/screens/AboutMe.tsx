...
export const AboutMe = () => {
  return (
    <>
      <div id="about-me" className="md:pt-28 xs:pt-4 bg-gray-900">
        <div className="pl-20 xs:pl-0">
          <h1 className="mt-4 xs:mt-0 xs:text-center md:text-left text-gray-300 font-mono text-4xl">
            About me
          </h1>
        </div>
        <div className="flex flex-col md:flex-row items-center md:items-start md:mt-20 xs:mt-6 w-full px-4">
          {/* Imagem à esquerda */}
          ...
          <div className="md:w-2/3 mt-8 md:mt-0 md:pl-10">
            <p className="text-gray-400 md:text-xl md:text-left xs:text-sm xs:text-center font-bold max-w-4xl leading-relaxed">
