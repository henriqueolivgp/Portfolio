      ...
      <footer className="bg-slate-950 font-monoshadow dark:bg-gray-800">
        <div className="w-full mx-auto max-w-screen-xl p-10 md:flex items-center justify-between">
          <span className="text-sm text-PCinza sm:text-center dark:text-gray-400">
            © {currentYear}{" "}
            <Link href="https://github.com/henriqueolivgp" target="_blank" className="hover:underline">
              Henrique Oliveira™
            </Link>
            . All Rights Reserved.
          </span>
          <div className="flex items-center text-sm mr-10 font-medium text-PCinza sm:mt-0">
              <a href="https://www.linkedin.com/in/henrique-oliveira-gp" target="_blank" className="hover:underline me-4 md:me-6">
                <img className=" w-6" src="../assets/SocialNetworks/linkedin.png" alt="linkedin" />
              </a>
