...
export const AboutMe = () => {
  return (
    <>
      <div id="about-me" className="md:pt-28 xs:pt-4 bg-gray-900 flex items-center justify-center min-h-screen">
        <div className="w-full">
          <h1 className="mt-4 xs:mt-0 xs:text-center text-gray-300 font-mono text-4xl">
            About me
          </h1>
          <div className="flex flex-col md:flex-row md:items-center md:justify-center md:mt-10 xs:mt-6 w-full">
            ...
            <div className="md:w-1/3 flex justify-center">
              <img
                className="w-96 xs:w-72 rounded-md"
                src="/me.jpg"
                alt="My portrait"
              />
            </div>
            {/* Texto à direita */}
            <div className="md:w-2/3 mt-8 md:mt-0 flex flex-col items-center p-4">
              <p className="text-gray-400 md:text-xl xs:text-sm xs:text-center md:text-left font-bold max-w-4xl leading-relaxed">
